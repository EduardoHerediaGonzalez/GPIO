...
void resetComponentStaticVariables(void)
{
	...
	for(u8PortIndex = (uint8)STD_nZERO; u8PortIndex < (uint8)GPIO_enTotalOfPorts; u8PortIndex++)
	{
		...
		{
			GPIO_s_astPort[u8PortIndex].astPin[u8PinIndex].u8Number = GPIO_astPortConfig[u8PortIndex].astPin[u8PinIndex].u8Number;
			GPIO_s_astPort[u8PortIndex].astPin[u8PinIndex].u8Mode = GPIO_astPortConfig[u8PortIndex].astPin[u8PinIndex].u8Mode;
			GPIO_s_astPort[u8PortIndex].astPin[u8PinIndex].u8Speed= GPIO_astPortConfig[u8PortIndex].astPin[u8PinIndex].u8Speed;
			GPIO_s_astPort[u8PortIndex].astPin[u8PinIndex].u8AlternateFunction = GPIO_astPortConfig[u8PortIndex].astPin[u8PinIndex].u8AlternateFunction;
		}
	}
}
...
IGNORE_TEST(GPIO_vInit, Test_2)
{
	...
	GPIO_s_astPort[GPIO_enPortC].astPin[GPIO_enPin7].u8Number = (uint8)GPIO_enTotalOfPins;
...
IGNORE_TEST(GPIO_vInit, Test_3)
{
	...
	GPIO_s_astPort[GPIO_enPortC].astPin[GPIO_enPin7].u8Mode = (uint8)GPIO_enTotalOfPinModes;
...
IGNORE_TEST(GPIO_vInit, Test_4)
{
	...
	GPIO_s_astPort[GPIO_enPortC].astPin[GPIO_enPin7].u8Speed = (uint8)GPIO_enTotalOfPinSpeeds;
...
IGNORE_TEST(GPIO_vInit, Test_5)
{
	...
	GPIO_s_astPort[GPIO_enPortC].astPin[GPIO_enPin7].u8AlternateFunction = (uint8)GPIO_enTotalOfPinAlternateFunctions;
